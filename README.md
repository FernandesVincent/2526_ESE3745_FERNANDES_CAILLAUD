...
Donc le temps de commutation total pour monter est de 46 ns et pour descendre 74ns. Ce qui correspond au dead time (DT) est donc le temps de descente, ie 74ns. 
...
On obtient donc pour valeur : 14 (en ayant gardé une petite marge sur le temps de descente)