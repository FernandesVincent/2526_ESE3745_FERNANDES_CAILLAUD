...
Donc le temps de commutation total pour monter est de 46 ns et pour descendre 74ns. Ce qui correspond au dead time (DT) est donc 120ns. On prend plus pour être large 
